...
/************************************* SEND TO PREWEIGHT ************************************
	...
	$(document).delegate('#btnCfSPW', 'click', function() {
		...
		acq_sendtoplan($('#cur_spw_key').val()); // , $('#cur_spw_batchnokey').val()
...
/************************************* SEND TO Approve *************************************/
	$('.btnapprove').on('click', function() {
		...
		$('#cur_spw_key').val(actionKey);
		$('#modal_dialog').removeClass('modal-success').addClass('modal-warning');
		$('.modal-header').children('h4').html('Send Approve QC confirmation!');
		$('.modal-body').children().html('Are you sure you want to QC Approve with PD_ORDER \"'+pd_order+'\"?');
		$('.modal-footer').children('.btn:nth-child(1)').css('display','');
	...
	$(document).delegate('#btnCfSMX', 'click', function() {
		...
		acq_sendtoapproveqc($('#cur_spw_key').val());
...
/************************************* SEND TO HOLD *************************************/
	$('.btnhold').on('click', function() {
		...
		$('#cur_spw_key').val(actionKey);
		$('#modal_dialog').removeClass('modal-success').addClass('modal-warning');
		$('.modal-header').children('h4').html('Send to HOLD confirmation!');
		$('.modal-body').children().html('Are you sure you want to HOLD with PD_ORDER \"'+pd_order+'\"?');
		$('.modal-footer').children('.btn:nth-child(1)').css('display','');
		$('.modal-footer').children('.btn:nth-child(1)').attr('id','btnCfHOLD');
		$('.modal-footer').children('.btn:nth-child(1)').html('Send');
		$('.modal-footer').children('.btn:nth-child(2)').css('display','');
		$('.modal-footer').children('.btn:nth-child(2)').attr('id','btnCfDonotHOLD');
		$('.modal-footer').children('.btn:nth-child(2)').html('Cancel');
		$('#modal_dialog').modal('show');
	});

	$(document).delegate('#btnCfDonotHOLD', 'click', function() {
	...
	$(document).delegate('#btnCfHOLD', 'click', function() {

		acq_sendtohold($('#cur_spw_key').val());
...
/************************************* SEND TO Extra *************************************/
	$('.btnextra').on('click', function() {
		...
		$('#modal_dialog').removeClass('modal-success').addClass('modal-warning');
		$('.modal-header').children('h4').html('Send to HOLD confirmation!');
		$('.modal-body').children().html('Are you sure you want to Extra Rawmaterial with PD_ORDER \"'+pd_order+'\"?');
		$('.modal-footer').children('.btn:nth-child(1)').css('display','');
		$('.modal-footer').children('.btn:nth-child(1)').attr('id','btnCfEXTRA');
		$('.modal-footer').children('.btn:nth-child(1)').html('Send');
		$('.modal-footer').children('.btn:nth-child(2)').css('display','');
		$('.modal-footer').children('.btn:nth-child(2)').attr('id','btnCfDonotEXTRA');
		$('.modal-footer').children('.btn:nth-child(2)').html('Cancel');
		$('#modal_dialog').modal('show');
	});

	$(document).delegate('#btnCfDonotEXTRA', 'click', function() {
	...
	$(document).delegate('#btnCfEXTRA', 'click', function() {

		acq_sendtoextra($('#cur_spw_key').val());
...
function acq_sendtoapproveqc(pd_order) {
...
function acq_sendtohold(pd_order) {
...
// EXTRA
function acq_sendtoextra(pd_order) {
