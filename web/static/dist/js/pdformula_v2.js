...
/********************* SEND TO MASTER TEMPLATE **********************/
	...
	$(document).delegate('.btndtotemplate', 'click', function() {
		...
		var cur_version = $('#lbl_fmversion_'+actionKey).html();
		//var bay_default_def = $('#settmp_'+actionKey).html();
		var bay_default_def = $('#cur_fm_bayfocus').val();
		
		
		// var bay_focus_defb1t1 = $('#setbaydefb1t1_'+actionKey).html();
		// var bay_focus_defb1t2 = $('#setbaydefb1t2_'+actionKey).html();
		// var bay_focus_defb2 = $('#setbaydefb2_'+actionKey).html();
		// var bay_focus_defb3 = $('#setbaydefb3_'+actionKey).html();
		// var bay_focus_defb4 = $('#setbaydefb4_'+actionKey).html();
		// var bay_focus_defb5 = $('#setbaydefb5_'+actionKey).html();		

		//var pd_batchno = $('#lbl_batchno_'+actionKey).html();

		console.log('controlId ' + controlId);
		console.log('actionKey' + actionKey);
		console.log('fm_code ' + pd_order);
		console.log('cur_version ' + cur_version);					
		// console.log('cur_fm_bayfocus html ' + $('#cur_fm_bayfocus').html());

		console.log('cur_fm_bayfocus  val    ' + bay_default_def);
		// console.log('bay_focus_defb1t1 ' + bay_focus_defb1t1);	
		// console.log('bay_focus_defb1t2 ' + bay_focus_defb1t2);	
		// console.log('bay_focus_defb2 ' + bay_focus_defb2);	
		// console.log('bay_focus_defb3 ' + bay_focus_defb3);	
		// console.log('bay_focus_defb4 ' + bay_focus_defb4);									
		// console.log('bay_focus_defb5 ' + bay_focus_defb5);			
		  		
		$('#cur_spw_key').val(actionKey);
		$('#cur_fm_code').val(pd_order);
		$('#cur_fm_version').val(String(cur_version));
		$('#cur_fm_bayfocus').val(bay_default_def);
		$('#modal_dialog').removeClass('modal-success').addClass('modal-warning');
		$('.modal-header').children('h4').html('Set To Template confirmation!');
		$('.modal-body').children().html('Are you sure you want to Assign  \"'+pd_order+'\" in VERSION \"'+cur_version+'\" to Template?');
...
// $('#cur_fm_version').val()
		acq_sendtotemplate($('#cur_spw_key').val(), $('#cur_fm_code').val(), $('#cur_fm_version').val(), $('#cur_fm_bayfocus').val());
...
function acq_sendtotemplate(fm_id, fm_code, fm_version, fm_bay_focus) {
...
console.log('acq : fm_version : '+ fm_version);
	$.ajax({
	  type: "POST",
	  url: "ajax_fw_sendtotemplate_v2.php",
	  async:false,
	  data: {
			"fm_id": fm_id,
			"fm_code": fm_code,
			"fm_version": fm_version,
			"fm_bay_focus": fm_bay_focus,	  		  		  	
