	...
	$(document).delegate('#btnCfSMX', 'click', function() {
       ...
       if(baydata == '1'){
		   acq_sendtomix_bay1($('#cur_spw_key').val());
	    	...
	    	acq_sendtomix_bay9($('#cur_spw_key').val());
	    }else if(baydata == '10'){
	    	acq_sendtomix_bay10($('#cur_spw_key').val());	    		    		    		    		    	
	   }else{
...
/*************************************  Send to Backward *************************************/
	...
	$(document).delegate('#btnCfBWMX', 'click', function() {
       ...
       if(baydata == 'MIXING BAY 1'){
	    ...
	    }else if(baydata == 'MIXING BAY 8'){
	    	acq_backward_bay($('#cur_spw_key').val(), '8');	 
	    }else if(baydata == 'MIXING BAY 9'){
	    	acq_backward_bay($('#cur_spw_key').val(), '9');
	    }else if(baydata == 'MIXING BAY 10'){
	    	acq_backward_bay($('#cur_spw_key').val(), '10');	
...
function acq_sendtomix_bay8(pd_order) {
...
function acq_sendtomix_bay9(pd_order) {
...
function acq_sendtomix_bay10(pd_order) {
